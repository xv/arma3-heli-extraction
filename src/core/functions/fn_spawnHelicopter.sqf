...
_heliClass = switch (side player) do
{
    case west:
    {
        switch (faction player) do
        {
            ...
            case "rhsgref_faction_cdf_air_b":    { "rhsgref_cdf_b_reg_Mi8amt"        }; // RHS CDF Air Forces
            case "rhsgref_faction_cdf_ng_b":     { "rhsgref_cdf_b_reg_Mi8amt"        }; // RHS CDF National Guard
            case "rhsgref_faction_cdf_ground_b": { "rhsgref_cdf_b_reg_Mi8amt"        }; // RHS CDF Ground Forces
